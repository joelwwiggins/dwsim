...
declare module '$env/static/private' {
	...
	export const DOTNET_GENERATE_ASPNET_CERTIFICATE: string;
	export const npm_config_cache: string;
	export const DOTNET_ROOT: string;
	export const DOTNET_SDK_VERSION: string;
	export const npm_config_node_gyp: string;
	export const PATH: string;
	export const NODE: string;
	export const npm_package_name: string;
	export const ASPNETCORE_HTTP_PORTS: string;
	...
	export const ASPNET_VERSION: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		TERM: string;
		DOTNET_GENERATE_ASPNET_CERTIFICATE: string;
